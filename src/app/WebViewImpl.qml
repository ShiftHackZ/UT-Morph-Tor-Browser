...
WebView {
    ...
    LomiriShape {
            ...
            ActionList {
                ...
                Action {
                    name: "selectmore"
                    text: (quickMenu.textSelectionLevels.length == 0)    ? i18n.dtr('lomiri-ui-toolkit', "Select Element")
    ...
    // https://github.com/ubports/morph-tor-browser/issues/92
